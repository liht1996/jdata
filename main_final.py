...
if tran:
    ...
    fea_imp_s1.to_csv('./fea_imp_train/B_test_3615.csv')
    fea_imp_s2.to_csv('./fea_imp_train/B_test_3615.csv')
    print ('fmp保存完成！')
##################################################################################################################################################
###提交
if sub:
    ...
    submit.to_csv('./submit/B_test_3615_5monwinDel6monPinghua_Updateratio_again.csv',index=None)
    print ('提交结果保存完成！')
#################################################################################################33
